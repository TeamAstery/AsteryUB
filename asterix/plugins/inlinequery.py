        ...
        inline_query.answer(
            results=[
                InlineQueryResultPhoto(
                    ...
                    title="astery security system",
                    description="This is astery security system, it helps you to stop spammers from spamming in your dm.",
        ...
        inline_query.answer(
            results=[
                InlineQueryResultPhoto(
                    ...
                    title="Introduction to astery",
                    description="This is the astery helpdex menu.",
