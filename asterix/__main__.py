...
async def start_bot():
    ...
    """
    print(
        "___________________________________. Welcome to Astery World .___________________________________\n\n\n"
    )
    ...
    await start_userbot()
    print("You successfully deployed Astery Userbot, try .ping or .alive to test it.")
